...
#' @param year Logical. If \code{TRUE} then results will be reported grouped by year using the \code{DateModified} field from the data forms. Defaults to \code{FALSE}.
#' @export
